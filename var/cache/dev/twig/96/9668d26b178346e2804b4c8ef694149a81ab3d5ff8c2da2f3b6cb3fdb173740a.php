...
class __TwigTemplate_99fd323415caef312da4353de103ae0066e16bd8a6191d0939f890235ec0a2ff extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 19
        ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19),  -1)) ? (print ("Unlimited")) : (print (twig_escape_filter($this->env, sprintf("%.0f MB", ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19) / 1024) / 1024)), "html", null, true))));
        echo "</span>
        </div>
    ";
...
{% endblock %}
", "@WebProfiler/Collector/memory.html.twig", "C:\\Users\\willi\\Desktop\\Symfony\\Project\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\memory.html.twig");
    }
}
